...
addEventListener("DOMContentLoaded", (event) => {
	...
	dom_dots.forEach((dot) => {
		dot.addEventListener("click", (e) => {
			let clicked_index = parseInt(dot.getAttribute("data-number")) // On récupère l’index cliqué (+ conversion en entier)
			...
			current_index=clicked_index // On met à jour l’index
